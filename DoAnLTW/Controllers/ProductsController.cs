...
namespace DoAnLTW.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(DoAnLTWContext context)
        {
            _context = context;
        }
        ...
        {
            var doAnLTWContext = _context.Product.Include(p => p.category);
		...
		{
			var doAnLTWContext = _context.Product.Include(p => p.category).Where(p => p.Name.Contains(keywords) && p.CategoryId==catid);
			return View(await doAnLTWContext.ToListAsync());
		}
